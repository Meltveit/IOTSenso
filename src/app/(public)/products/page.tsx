...
const products: Product[] = [
  {
    ...
    price: 3490,
    monthlyFee: 99,
    imageUrl: "https://picsum.photos/seed/snowguard/600/400",
  ...
  },
  {
    ...
    price: 2990,
    monthlyFee: 79,
    imageUrl: "https://picsum.photos/seed/snowlevel/600/400",
  ...
  },
  {
    ...
    price: 1890,
    monthlyFee: 59,
    imageUrl: "https://picsum.photos/seed/basement/600/400",
  ...
  },
  {
    ...
    price: 2490,
    monthlyFee: 69,
    imageUrl: "https://picsum.photos/seed/gutter/600/400",
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold font-headline">Våre Produkter</h1>
            <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">Finn den perfekte SensoGuard-sensoren for dine behov, fra overvåking av snølast til forebygging av fuktskader.</p>
        </div>
